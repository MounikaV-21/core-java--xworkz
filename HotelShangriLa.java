class HotelShangriLa{
 //50 items
 static String foodMenu[] = {"Chhole","Pav Bhaji","Mix Veg","Channa Masala","Corn Capsicum","Green Garden","Paneer Bhurji","Panner Butter masala",
 ...
 public static void main(String hotel[]){
  ...
  System.out.println(foodMenu[0] + " " + foodMenu[1] + " " + foodMenu[2] + " " + foodMenu[3] + " " + foodMenu[4] + " " + foodMenu[5] + " " + foodMenu[6] + " " + foodMenu[7] + " "+ foodMenu[8] + " " + foodMenu[9] + " " + 
    foodMenu[10] + " " + foodMenu[11] + " " + foodMenu[12] + " " + foodMenu[13] + " " + foodMenu[14] + " " + foodMenu[15] + " " + foodMenu[16] + " " + foodMenu[17] + " "+ foodMenu[18] + " " + foodMenu[19] + " " +   
    foodMenu[20] + " " + foodMenu[21] + " " + foodMenu[22] + " " + foodMenu[23] + " " + foodMenu[24] + " " + foodMenu[25] + " " + foodMenu[26] + " " + foodMenu[27] + " " + foodMenu[28] + " "+ foodMenu[29] + " " + foodMenu[30] + " " +   
